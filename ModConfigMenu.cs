...
namespace MarketTown
{
    ...
    public partial class ModEntry
    {
        ...
        public static void ConfigMenu(IContentPatcherAPI api, IManifest ModManifest, IModHelper Helper)
        {
            ...
            configMenu.AddBoolOption(
                mod: ModManifest,
                name: () => SHelper.Translation.Get("foodstore.config.onlyknowrecipe"),
                tooltip: () => SHelper.Translation.Get("foodstore.config.onlyknowrecipeText"),
                getValue: () => Config.OnlyKnowRecipe,
                setValue: value => Config.OnlyKnowRecipe = value
            );
