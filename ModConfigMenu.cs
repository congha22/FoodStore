...
namespace MarketTown
{
    ...
    public partial class ModEntry
    {
        ...
        public static void ConfigMenu (IContentPatcherAPI api, IManifest ModManifest, IModHelper Helper)
        {
            ...
            configMenu.AddNumberOption(
                mod: ModManifest,
                name: () => SHelper.Translation.Get("foodstore.config.hardmode"),
                tooltip: () => SHelper.Translation.Get("foodstore.config.hardmodeText"),
                getValue: () => Config.HardMode,
                setValue: value => Config.HardMode = value,
                min: 0.0f,
                max: 1.0f,
                interval: 0.01f
            );
            ...
            configMenu.AddPageLink(mod: ModManifest, "smartphone", () => SHelper.Translation.Get("foodstore.config.smartphone"));
            ...
            configMenu.AddBoolOption(
                mod: ModManifest,
                name: () => SHelper.Translation.Get("foodstore.config.disablesellnotice"),
                tooltip: () => SHelper.Translation.Get("foodstore.config.disablesellnoticeText"),
                getValue: () => Config.DisableSellNotice,
                setValue: value => Config.DisableSellNotice = value
            );
            configMenu.AddBoolOption(
                mod: ModManifest,
            ...
            configMenu.AddTextOption(
                mod: ModManifest,
                name: () => "AI model? (e.g. gpt-4o-mini)",
                tooltip: () => "If you have personal OpenAI model and key, you can customize to your own. Only modify this box if you know what you are doing!!!",
                getValue: () => "" + Config.AdvanceAiModel,
                setValue: delegate (string value) { try { Config.AdvanceAiModel = value; } catch { } }
            );
            configMenu.AddTextOption(
                mod: ModManifest,
                name: () => "AI key? (e.g. sk-1234)",
                tooltip: () => "If you have personal OpenAI model and key, you can customize to your own. Only modify this box if you know what you are doing!!!",
                getValue: () => "" + Config.AdvanceAiKey,
                setValue: delegate (string value) { try { Config.AdvanceAiKey = value; } catch { } }
            );
            configMenu.AddTextOption(
                mod: ModManifest,
                name: () => "AI limit? (e.g. 10)",
                tooltip: () => "This is the limit of AI call each in-game hour. Only work if you have personal model-key",
                getValue: () => "" + Config.AdvanceAiLimit,
                setValue: delegate (string value) { try { Config.AdvanceAiLimit = int.Parse(value, CultureInfo.InvariantCulture); } catch { } }
            );
            //// **************************** end of AI content
            ...
            configMenu.AddPage(mod: ModManifest, "smartphone", () => SHelper.Translation.Get("foodstore.config.smartphone"));
            configMenu.AddBoolOption(
                mod: ModManifest,
                name: () => SHelper.Translation.Get("foodstore.config.smartphoneEnable"),
                tooltip: () => SHelper.Translation.Get("foodstore.config.smartphoneEnableText"),
                getValue: () => Config.SmartphoneEnable,
                setValue: value => Config.SmartphoneEnable = value
            );
            configMenu.AddNumberOption(
                mod: ModManifest,
                name: () => SHelper.Translation.Get("foodstore.config.smartphoneMessageChance"),
                tooltip: () => SHelper.Translation.Get("foodstore.config.smartphoneMessageChanceText"),
                getValue: () => Config.SmartphoneMessageChange,
                setValue: value => Config.SmartphoneMessageChange = value,
                min: 0.0f,
                max: 1.0f,
                interval: 0.01f
            );
