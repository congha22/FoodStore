...
public class ParadiseBoat : IMinigame
{
    public class WaterSparkle : Entity
    {
        protected Vector2 _startPosition;

        public WaterSparkle(ParadiseBoat context)
    ...
    public class Wave : Entity
    {
        ...
        public Wave(ParadiseBoat context, Vector2 position = default(Vector2))
    ...
    public class Boat : Entity
    {
        ...
        public Boat(ParadiseBoat context, string texture_path, Rectangle source_rect, Vector2 origin = default(Vector2), Vector2 position = default(Vector2))
    ...
    public class Entity
    {
        protected ParadiseBoat _context;
        ...
        public Entity(ParadiseBoat context, string texture_path, Rectangle source_rect, Vector2 origin = default(Vector2), Vector2 position = default(Vector2))
        {
            _context = context;
    ...
    public Vector2[] points = new Vector2[]
    {
        ...
        new Vector2(253f, 333f),
        new Vector2(295f, 440f),
        new Vector2(490f, 490f)
    };
    ...
    {
        return "Mods\\d5a1lamdtd.MarketTown.Custom_MT_Location\\ParadiseBoat_" + Game1.currentSeason;
    }
    ...
    public bool tick(GameTime time)
    {
        if (_fadeComplete)
        {
            Game1.warpFarmer("Custom_MT_Island", 25, 60, 0);
            return true;
        }
